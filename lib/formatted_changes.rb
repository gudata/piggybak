  ...
  module FormattedChanges
    ...
    def new_destroy_changes(type)
      ...
      self.attributes.each do |k, v|
        if !["updated_at", "created_at", "id", "order_id", "billing_address_id", "shipping_address_id", "sellable_id", "line_item_type", "sort"].include?(k)
    ...
    def formatted_changes
      ...
      self.changes.each do |k, v|
        if !["updated_at", "id", "billing_address_id", "shipping_address_id", "created_at", "sellable_id", "line_item_type", "sort"].include?(k)
